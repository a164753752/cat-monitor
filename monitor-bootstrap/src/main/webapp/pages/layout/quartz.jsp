    ...
    <link href="${pageContext.request.contextPath}/front_frame/Cron/themes/bootstrap/easyui.css" rel="stylesheet" type="text/css" />
    <link href="${pageContext.request.contextPath}/front_frame/Cron/themes/icon.css" rel="stylesheet" type="text/css" />
    <link href="${pageContext.request.contextPath}/front_frame/Cron/icon.css" rel="stylesheet" type="text/css" />
    <script src="${pageContext.request.contextPath}/front_frame/assets/js/jquery-1.10.2.min.js" type="text/javascript"></script>
    <script src="${pageContext.request.contextPath}/front_frame/Cron/jquery.easyui.min.js" type="text/javascript"></script>
    <script src="${pageContext.request.contextPath}/front_frame/Cron/cron.js" type="text/javascript"></script>
    <style type="text/css">
        .line
        {
            height: 25px;
